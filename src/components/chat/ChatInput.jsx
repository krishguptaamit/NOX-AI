      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 p-2 md:p-3 shadow-[0_0_35px_rgba(139,92,246,.12)]">
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="flex h-10 w-10 md:h-11 md:w-11 items-center justify-center rounded-xl hover:bg-violet-500/10 transition">
          ...
          <button
            className="flex h-11 w-11 md:h-12 md:w-12 items-center justify-center rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 shadow-[0_0_25px_rgba(139,92,246,.4)] transition hover:scale-105"
          >
